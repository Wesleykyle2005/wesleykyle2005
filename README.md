[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=700&size=40&duration=2000&pause=2000&color=8B5CF6&vCenter=true&width=500&height=55&lines=Hey%2C+I'm+Wesley+·͜·)](https://git.io/typing-svg)
[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=500&size=24&duration=3000&pause=1500&color=A78BFA&vCenter=true&width=600&height=40&lines=Machine+Learning+Engineer;RPA+%26+AI+Automation+Specialist;Python+%7C+UiPath+%7C+n8n+%7C+.NET)](https://git.io/typing-svg)

---

## Hey, I'm Wesley ·͜· <img src="images/octocat.png" width="400" align="right"/>
...
<!-- BEGIN CHESS BOARD -->
<p align="center"><img src="images/chess.gif?v=20260802214610" alt="voxel chess board" width="520"></p>
<!-- END CHESS BOARD -->
...
| **C1** | [D2](https://github.com/wesleyruiz2005/wesleyruiz2005/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+C1+to+D2), [E3](https://github.com/wesleyruiz2005/wesleyruiz2005/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+C1+to+E3), [F4](https://github.com/wesleyruiz2005/wesleyruiz2005/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+C1+to+F4), [G5](https://github.com/wesleyruiz2005/wesleyruiz2005/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+C1+to+G5), [H6](https://github.com/wesleyruiz2005/wesleyruiz2005/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+C1+to+H6) |
...
| **D1** | [D2](https://github.com/wesleyruiz2005/wesleyruiz2005/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+D1+to+D2), [D3](https://github.com/wesleyruiz2005/wesleyruiz2005/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+D1+to+D3) |
| **D4** | [D5](https://github.com/wesleyruiz2005/wesleyruiz2005/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+D4+to+D5) |
| **E1** | [D2](https://github.com/wesleyruiz2005/wesleyruiz2005/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+E1+to+D2) |
...
| Move | Author |
| :--: | :----- |
| `G8` to `F6` | [ @CADV2005](https://github.com/CADV2005) |
| `A2` to `A4` | [ @wesleyruiz2005](https://github.com/wesleyruiz2005) |
| `A7` to `A5` | [ @CharlyFernando](https://github.com/CharlyFernando) |
| `D2` to `D4` | [ @wesleyruiz2005](https://github.com/wesleyruiz2005) |
...
| 1 | [@CADV2005](https://github.com/CADV2005) |
...
![scikit-learn](https://img.shields.io/badge/scikit--learn-0D1117?style=for-the-badge&logo=scikitlearn&logoColor=8B5CF6)
![LightGBM](https://img.shields.io/badge/LightGBM-0D1117?style=for-the-badge&logo=lightgbm&logoColor=8B5CF6)
![XGBoost](https://img.shields.io/badge/XGBoost-0D1117?style=for-the-badge&logo=xgboost&logoColor=8B5CF6)
...
![Jupyter](https://img.shields.io/badge/Jupyter-0D1117?style=for-the-badge&logo=jupyter&logoColor=8B5CF6)
![Matplotlib](https://img.shields.io/badge/Matplotlib-0D1117?style=for-the-badge&logo=matplotlib&logoColor=8B5CF6)
...
![SQL Server](https://img.shields.io/badge/SQL%20Server-0D1117?style=for-the-badge&logo=microsoftsqlserver&logoColor=8B5CF6)
![SQLite](https://img.shields.io/badge/SQLite-0D1117?style=for-the-badge&logo=sqlite&logoColor=8B5CF6)
![MongoDB](https://img.shields.io/badge/MongoDB-0D1117?style=for-the-badge&logo=mongodb&logoColor=8B5CF6)
![.NET](https://img.shields.io/badge/.NET-0D1117?style=for-the-badge&logo=dotnet&logoColor=8B5CF6)
...
![GitHub Actions](https://img.shields.io/badge/GitHub%20Actions-0D1117?style=for-the-badge&logo=githubactions&logoColor=8B5CF6)
![Azure DevOps](https://img.shields.io/badge/Azure%20DevOps-0D1117?style=for-the-badge&logo=azuredevops&logoColor=8B5CF6)
...
@@               4!4`J4` `44444444474                                              @@
@@  ..   .      J|7`'41 -  44JJ44444'                                              @@
@@ 77   (    -= |4- -444ku44444444?'                          L)..)))L             @@
@@ 7l   ' |-`7' 44' 744``"J``"747`                         .4|)444444))))          @@
@@ Sl      ^"   ?SS. ?SS?4Sb. '                           444SSS44))4S411b         @@
@@ S(     x   .  "4?^ `  `"`                             44SSSS44?)))444)))        @@
@@ Jl      k.=x     .                                   .4JJJ4JJ4k)))14444)        @@
@@ SJ ` .k^ ?J?` ^  )|) )                .|((((=..      '44SSS?SS4)4l )))4)        @@
@@ 4S(       7      |4k ))              44!ll44!!||.     74S7 , 7S44)  ))?      ,  @@
@@ SSl      |!.     !1? 1k)            d111SSSSSS!!!|     ` Sk..JS1? J `" )l. .4?) @@
@@ SS(      |S)     )'  )):            4))4SSS4SS44||      `4`?S4S)) 4k.    xdS?)) @@
@@ ?SS      !S!     x`x  ))            ?144JSSSSSS!!S       `"4SS?'  JS?' .'d?4'41 @@
@@ :?S:     !:    x' o `x              :11$S$SSS$$!!?          "'`.uSS? .' d?d:1S1 @@
@@ (:S(     : ,"x'  ,-  x'             $""*s$S?*!s$S:            xuS$?  " .S)S)$?) @@
@@ I:?I      J'  .s^  x'  :       .)). ?. -.SS:-  S?              `*'   ?`S?d'dS1? @@
@@ $:1:      ?Jxx,.,=~   ::   .:1$$11: "*4$" ?$$x?*                      u$:1 $$1: @@
@@ (:",.   .J":zL ~="   :):  ::)sss): .   'zs$z"J            u.          s$:s z$): @@
@@ ..1?  x".?o.$:L==   : 1  :1:?1$$1:1?   ?1..,p? .:.  o,      "s       :$:d$ 1$:  @@
@@ s(isL ,s' ,        .: :  .: :)s$s:1:    '***" 1zJ:, ,,'"v,,, z:      :z:$s J$1  @@
@@ iii$sL.   ,      : :)    :  :11ss:s1 '.xszv  1zJii: .'*v,.,z)x'   .,  :s$'u1$s. @@
@@ ss(($s|x..'        :)    :   :)s) z)    z   jz s|:.  'x,,,,Jz:L. ',zL. :z s):z: @@
@@ s$$ss|z*'  ,        :        ;:)) ):    :   s*j|::    *~- v''x ' u$$j)i,: sj):, @@
@@ isz*'     ::        :       .: :: :     i  .z i:.      ,        ussss)))x '4)): @@
@@ ^ ,:       ,                      ;        :( :   J* ,* ,u     s)ss$s$s))L,:s)1 @@
@@  ,:|                                       :*    j; z*v*  ,     'vjjssssjv:u,:j @@
@@  ,(;                             ,,,, ,        , ssz*x,u*,v       'sjssjs:ussjj @@
@@   ::                          ,ujjssssssv        zLJ,Jz*            ,^'sjjssjs: @@
@@    ,                         z))ssssssssssL   ', '***`              :), '*ssj): @@
@@                            x)sss)ssssv' ') :                        j):,   '**j @@
@@                           ;jxxjjj-vsj    4*j,                       jj,  j,   , @@
@@                           sjsj)..jssssuvp;  j                       ,    ..,    @@
